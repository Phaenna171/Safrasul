...
export default function UtilizacaoEIndicacao() {
  ...
  function getUseAndIndication(label) {
    switch (label) {
      ...
      case "Fenação": return "/imgs/admin-products/icone_fenacao.png"
      case "Margens de Rodovias": return "/imgs/admin-products/icone_margens_de_rodovias.png"
      case "Palhada": return "/imgs/admin-products/icone_palhada.png"
      case "Pastoreio": return "/imgs/admin-products/icone_pastoreio.png"
      ...
      case "Gado de Corte": return "/imgs/admin-products/icone_gado_de_corte.png"
      case "Gado de Leite": return "/imgs/admin-products/icone_gado_de_leite.png"

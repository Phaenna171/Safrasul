                    ...
                    {products?.map((product, index) => (
                        <div key={index} className="w-[209px] h-[217px] flex-col items-center gap-2 inline-flex relative">
                            ...
                            <div className="items-center gap-3 inline-flex w-full">
                                <button onClick={() => setAddModalOpen(true)} className="flex-grow text-white text-xs font-normal transition-all hover:scale-105 h-[34px] px-2.5 py-[5px] bg-[#6f6f6f] rounded-lg flex items-center justify-center gap-2">
                                ...
                                <button onClick={() => setDeleteModalOpen(true)} className="flex-grow text-white text-xs font-normal transition-all hover:scale-105 h-[34px] px-2.5 py-[5px] bg-[#ea722d] rounded-lg flex items-center justify-center gap-2">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
